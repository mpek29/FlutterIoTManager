    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _ModeButton(
            mode: ChargingMode.dailyTrip,
            icon: Icons.calendar_today,
            color: AppColors.dailyOrange,
            description: AppStrings.dailyTripDescription,
            isSelected: selectedMode == ChargingMode.dailyTrip,
            onTap: () => onModeSelected(ChargingMode.dailyTrip),
          ),
        ],
      ),
    );
